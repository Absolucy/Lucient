...
internal extension Color {
	init?(hex string: String) {
		...
		if string.count == 2 {
			...
			self.init(.displayP3, red: gray, green: gray, blue: gray, opacity: 1)
			...
			self.init(.displayP3, red: gray, green: gray, blue: gray, opacity: alpha)
			...
			self.init(.displayP3, red: red, green: green, blue: blue, opacity: 1)
